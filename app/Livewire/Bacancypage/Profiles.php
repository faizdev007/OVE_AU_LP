...
class Profiles extends Component
{
    ...
    public function mount($lp_data)
    {
        ...
        [
            ["name"=>"Ashish Tomar","profile"=>"Full-Stack Developer","tools"=>"React, Node.js, MongoDB","info"=>"Builds scalable full-stack apps with modern JS frameworks.","avtar"=>"/assets/developers/Ashish Tomar.webp","company_logo"=>"/assets/previous/afterplay.webp","company"=>"AfterPlay"],
            ["name"=>"katrina","profile"=>"JAVA DEVELOPER","tools"=>"Java, Spring Boot, MySQL","info"=>"Designs scalable Java microservices for enterprise apps.","avtar"=>"/assets/developers/katrina.webp","company_logo"=>"/assets/previous/airwallex.webp","company"=>"AirWallex"],
            ...
            ["name"=>"Karthikeyan","profile"=>"FULL-STACK DEVELOPER","tools"=>"MERN Stack, GraphQL","info"=>"Delivers responsive, interactive web apps.","avtar"=>"/assets/developers/Karthikeyan.webp","company_logo"=>"/assets/previous/anz.webp","company"=>"ANZ"],
            ...
            ["name"=>"ashima","profile"=>"FULL-STACK WEB DEVELOPER","tools"=>"Django, React, AWS","info"=>"Combines Python backends with dynamic React front-ends.","avtar"=>"/assets/developers/ashima.webp","company_logo"=>"/assets/previous/seek.webp","company"=>"Seek"],
            ...
            ["name"=>"nayan","profile"=>"FULL-STACK DEVELOPER","tools"=>"React, Node.js, MongoDB","info"=>"Builds modern, scalable full-stack systems.","avtar"=>"/assets/developers/nayan.webp","company_logo"=>"/assets/previous/bhp.webp","company"=>"BHP"],
            ["name"=>"Aarif","profile"=>"AI ENGINEER","tools"=>"Python, TensorFlow, AWS SageMaker","info"=>"Designs and deploys deep learning pipelines for computer vision in production.","avtar"=>"/assets/developers/Aarif.webp","company_logo"=>"/assets/previous/linktree.webp","company"=>"LinkTree"],
